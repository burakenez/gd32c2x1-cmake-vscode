[![GitHub tag (latest by date)](https://img.shields.io/github/v/tag/burakenez/gd32c2x1-cmake-vscode)](https://github.com/burakenez/gd32c2x1-cmake-vscode/tags/)

# GD32C2x1 Demo Suites CMake Visual Studio Code Integration

🚀 Welcome to the **GD32C2x1 Demo Suites CMake Visual Studio Code** repository! This project integrates the CMake build system with Visual Studio Code for **_[GD32C2x1 Demo Suites V1.2.0](https://www.gd32mcu.com/en/download)_** and **_[GD32C2x1 Firmware Library V1.3.0](https://www.gd32mcu.com/en/download)_**, running entirely inside a container — **no local toolchain installation needed**.
...
```bash
git clone https://github.com/burakenez/gd32c2x1-cmake-vscode.git
```
...
### 2. **CMSIS/GD/GD32C2x1**
- **Version:** `V1.2.0 (2026-02-06)`
- **Path:** `Drivers/CMSIS/GD/GD32C2x1`
- **Source:** `GD32C2x1 Demo Suites V1.2.0`
...
│           │   ├── Core
│           │   │   ├── Inc
│           │   │   │   ├── gd32c2x1_it.h      # Interrupt handler declarations
│           │   │   │   ├── gd32c2x1_libopt.h  # Library options
│           │   │   │   └── systick.h                                  # SysTick timer declarations
│           │   │   └── Src
│           │   │       ├── gd32c2x1_it.c      # Interrupt service routines
│           │   │       ├── main.c                                     # Application entry point
│           │   │       ├── system_gd32c2x1.c  # Clock and core initialisation
│           │   │       └── systick.c                                  # SysTick timer implementation
│           │   ├── Startup
│           │   │   └── startup_gd32c2x1.s     # Reset handler and vector table
...
│           ├── Drivers
│           │   ├── BSP/GD32C231C_EVAL              # Board support package for GD32C231C_EVAL
│           │   ├── CMSIS                                 # CMSIS for Cortex-M / GD32C2x1
│           │   └── GD32C2x1_standard_peripheral  # Standard peripheral library
│           ├── .clang-format                # Code style rules
│           ├── CMakeLists.txt               # Top-level CMake build file
│           ├── CMakePresets.json            # Debug / Release preset definitions
│           ├── gd32c2x1_flash.ld  # Linker script (memory regions)
│           └── GD32C2x1.svd             # SVD file for peripheral register views
